...
description: Coordinator for comprehensive research projects requiring multiple specialized agents working in sequence. Manages the entire research workflow from query clarification through report generation.
