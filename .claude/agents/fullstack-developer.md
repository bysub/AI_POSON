  ...
  return (
    ...
    >
      <div className="p-6">
        ...
        <p className="mb-4 line-clamp-3 text-gray-600">{post.content.substring(0, 200)}...</p>
        ...
        {showActions && (
          <div className="flex items-center justify-between border-t border-gray-200 pt-4">
            ...
            <button
              ...
              className="flex items-center space-x-2 rounded-md px-3 py-1 text-sm text-blue-600 transition-colors hover:bg-blue-50 disabled:opacity-50"
            >
              <Heart className={`h-4 w-4 ${likeMutation.isLoading ? "animate-pulse" : ""}`} />
              <span>Like</span>
            </button>
          </div>
        )}
